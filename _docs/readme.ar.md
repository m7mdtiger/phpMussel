...
<div dir="rtl">بعد تثبيت phpMussel وعمله بشكل صحيح على نظامك, إذا قمت بضبط المتغيرات "script_password" و "logs_password" في ملف التكوين الخاص بك ستكون قادر على على أداء بعض من الوظائف الإدارية المحدودة و إدخال بعض من الأوامر لـphpMussel عبر متصفحك. توضع كلمات المرور لضمان الأمان والحماية الجيدة وللتأكد من وجود طريقة للسماح للمتصفح بتعطيلهم إذا لم يرغب أي مستخدم بإستخدام phpMussel.<br /><br /></div>

<div dir="rtl">عدة أسباب لإستخدام هذه الضوابط :<br /></div>
<div dir="rtl"><ul>
 <li>إذا أردت أن ترفع ملف وصنف بأنه فايروس وهو بالحقيقة غير ذلك, ولم يكن لديك الوقت الكاف للتعديل وإعادة الرفع.</li>
 ...
 <li>لمراقبة سجل ملفاتك.</li>
 <li>يوفر طريقة لتتمكن من مراقبة phpMussel عند عدم توفر مراقبة من قبل FTP أو نقاط الوصول التقليدية الأخرى.</li>
</ul></div>

<div dir="rtl">عدة أسباب لتعطيل هذه الضوابط:<br /></div>
<div dir="rtl"><ul>
 <li>يوفر طريقة للمهاجمين المحتملين وغير المرغوب فيهم لتحديد ما إذا كنت تستخدم phpMussel أم لا-قد تكون ميزة في بعض الأحيان ومضرة بأحيان أخرى- عن طريق إرسال أوامر بصورة عمياء إلى الخادم كوسيلة للفحص, وهذا يمكن أن يثني المهاجمين من استهداف النظام الخاص بك إذا كانوا يعلمون أنك تستخدم phpMussel أو استغلال بعض المداخل غير المتوقعة وغير المعروفة حاليا داخل phpMussel إذا كان على علم بوجود ثغرة في phpMussel.</li>
...
<div dir="rtl">آخر تحديث لهذه المعلومات كان في 21 أبريل 2016، و هي كذلك الحالية للإصدارين الثانويين الذين تم إصدارهما مؤخرا (v0.10.0-v1.0.0) من "بي اتش بي  ماسل".<br /><br /></div>
...
<div dir="rtl">آخر تحديث: 16 مايو 2016 (2016.05.16).</div>
